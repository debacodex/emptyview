package com.github.debacodex.emptyview;
...
public class EmptyViewBuilder {
	...
	EmptyViewBuilder(EmptyView emptyView, @NonNull AttributeSet attributeSet) {
		...
		try {
			...
			loadingTitleTextColor = a.getColor(R.styleable.EmptyView_ev_loading_titleTextColor, defaultTextColor);
			...
			emptyTitleTextColor = a.getColor(R.styleable.EmptyView_ev_empty_titleTextColor, defaultTextColor);
			...
			emptyButtonTextColor = a.getColor(R.styleable.EmptyView_ev_empty_buttonTextColor, defaultTextColor);
			emptyButtonBackgroundColor = a.getColor(R.styleable.EmptyView_ev_empty_buttonBackgroundColor, 0);
			...
			errorTitleTextColor = a.getColor(R.styleable.EmptyView_ev_error_titleTextColor, defaultTextColor);
			...
			errorButtonTextColor = a.getColor(R.styleable.EmptyView_ev_error_buttonTextColor, defaultTextColor);
			errorButtonBackgroundColor = a.getColor(R.styleable.EmptyView_ev_error_buttonBackgroundColor, 0);
