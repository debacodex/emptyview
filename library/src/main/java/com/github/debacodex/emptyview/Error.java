...
public enum Error {
	...
	TIMEOUT(R.string.error_connection_timeout_title, R.string.error_connection_timeout), SERVICE(0, 0),
	...
	public static Error get(Throwable e) {
		if (e instanceof ConnectException || e instanceof UnknownHostException) {
			return CONNECTION;
		} else if (e instanceof SocketTimeoutException || e instanceof TimeoutException || e instanceof SSLException) {
			return TIMEOUT;
